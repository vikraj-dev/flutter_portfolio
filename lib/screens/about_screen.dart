...
class AboutScreen extends StatelessWidget {
  ...
  Widget _infoCard() {
    return Container(
      ...
      child: Column(
        children: [
          const Floating3D(child: AvatarIllustration(size: 160)),
          ...
          Text('Flutter Developer', style: AppTextStyles.body(size: 14, color: AppColors.primary)),
          const SizedBox(height: 24),
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 10),
                  Expanded(
                    child: Text(PortfolioData.achievements[i], style: AppTextStyles.body(size: 14.5)),
                  ),
                ],
              ),
            ),
  ...
  Widget _highlightCard(IconData icon, String title, String subtitle, String funFact) {
    return SizedBox(
      width: 190,
      height: 130,
      child: Flip3DCard(
  ...
  Widget _highlightFace({required IconData icon, required String title, required String subtitle}) {
    return Container(
      width: 190,
      height: 130,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            title,
            style: AppTextStyles.body(size: 15, weight: FontWeight.w700, color: AppColors.textPrimary),
          ),
          const SizedBox(height: 4),
  ...
  Widget _highlightFaceBack(String funFact) {
    return Container(
      ...
      child: Text(
        ...
        style: AppTextStyles.body(size: 12.5, color: Colors.white, weight: FontWeight.w600),
      ),
    );
  }
}
